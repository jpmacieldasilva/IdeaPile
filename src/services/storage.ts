...
const DEFAULT_SETTINGS: AppSettings = {
  openaiModel: APP_CONFIG.ai.defaultModel,
  aiTemperature: APP_CONFIG.ai.temperature,
  theme: 'light',
...
class StorageService {
  ...
  async saveAICache(prompt: string, response: string, expiresIn: number = APP_CONFIG.storage.cacheTimeout): Promise<void> {
    try {
